...
public class ActivityBoardInMemorySeed implements ApplicationRunner {
    ...
    private void seedExchangeRules() {
        List<ExchangeRuleSeed> rules = List.of(
                new ExchangeRuleSeed("abv2-h2-small-water-gasoline", "加油换购-小水4瓶-GASOLINE",
                        "70545523", FuelType.GASOLINE, "180.00", "2.00", 4, 13),
                new ExchangeRuleSeed("abv2-h2-small-water-diesel", "加油换购-小水4瓶-DIESEL",
                        "70545523", FuelType.DIESEL, "300.00", "2.00", 4, 13),
                new ExchangeRuleSeed("abv2-h2-big-water-gasoline", "加油换购-大水4瓶-GASOLINE",
                        "70545526", FuelType.GASOLINE, "180.00", "4.00", 4, 14),
                new ExchangeRuleSeed("abv2-h2-big-water-diesel", "加油换购-大水4瓶-DIESEL",
                        "70545526", FuelType.DIESEL, "300.00", "4.00", 4, 14),
                new ExchangeRuleSeed("abv2-h2-redbull-gasoline", "加油换购-红牛3罐-GASOLINE",
                        "70356177", FuelType.GASOLINE, "180.00", "12.00", 3, 15),
                new ExchangeRuleSeed("abv2-h2-redbull-diesel", "加油换购-红牛3罐-DIESEL",
                        "70356177", FuelType.DIESEL, "300.00", "12.00", 3, 15),
                new ExchangeRuleSeed("abv2-h2-juice-1l-gasoline", "加油换购-优斯麦尔果汁1L-GASOLINE",
                        "70727173", FuelType.GASOLINE, "180.00", "9.90", 1, 16),
                new ExchangeRuleSeed("abv2-h2-juice-1l-diesel", "加油换购-优斯麦尔果汁1L-DIESEL",
                        "70727173", FuelType.DIESEL, "300.00", "9.90", 1, 16),
                new ExchangeRuleSeed("abv2-h2-juice-03l-gasoline", "加油换购-优斯麦尔果汁0.3L两瓶-GASOLINE",
                        "70727875", FuelType.GASOLINE, "180.00", "9.90", 2, 17),
                new ExchangeRuleSeed("abv2-h2-juice-03l-diesel", "加油换购-优斯麦尔果汁0.3L两瓶-DIESEL",
                        "70727875", FuelType.DIESEL, "300.00", "9.90", 2, 17),
                new ExchangeRuleSeed("abv2-h2-milk-200-gasoline", "加油换购-自有牛奶200g-GASOLINE",
                        "70559364", FuelType.GASOLINE, "180.00", "19.90", 1, 19),
                new ExchangeRuleSeed("abv2-h2-milk-200-diesel", "加油换购-自有牛奶200g-DIESEL",
